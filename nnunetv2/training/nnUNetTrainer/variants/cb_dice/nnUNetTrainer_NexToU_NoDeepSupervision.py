...
from nnunetv2.training.nnUNetTrainer.variants.cb_dice.NexToU import NexToU
...
class nnUNetTrainer_NexToU_NoDeepSupervision(nnUNetTrainerNoDeepSupervision):
    ...
    def build_network_architecture(
        ...
        mapping = {"PlainConvUNet": PlainConvUNet, "ResidualEncoderUNet": ResidualEncoderUNet, "NexToU": NexToU}
        kwargs = {
            "PlainConvUNet": {
                "conv_bias": True,
