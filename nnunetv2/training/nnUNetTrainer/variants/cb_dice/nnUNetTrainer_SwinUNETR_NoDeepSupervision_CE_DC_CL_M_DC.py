...
from nnunetv2.training.nnUNetTrainer.variants.cb_dice.nnUNetTrainer_SwinUNETR_NoDeepSupervision import (
    nnUNetTrainer_SwinUNETR_NoDeepSupervision,
)
...
class nnUNetTrainer_SwinUNETR_NoDeepSupervision_CE_DC_CL_M_DC(nnUNetTrainer_SwinUNETR_NoDeepSupervision):
    def _build_loss(self):
        ...
        loss = DC_and_CE_and_CL_M_DC_loss(
