...
class nnUNetPlannerResEncL_torchres(nnUNetPlannerResEncL):
    ...
    def determine_resampling(self, *args, **kwargs):
        ...
        resampling_data_kwargs = {"is_seg": False, "force_separate_z": False, "memefficient_seg_resampling": False}
        resampling_seg = resample_torch_fornnunet
        resampling_seg_kwargs = {"is_seg": True, "force_separate_z": False, "memefficient_seg_resampling": False}
    ...
    def determine_segmentation_softmax_export_fn(self, *args, **kwargs):
        ...
        resampling_fn_kwargs = {"is_seg": False, "force_separate_z": False, "memefficient_seg_resampling": False}
