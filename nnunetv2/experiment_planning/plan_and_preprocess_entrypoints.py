...
def _add_logging_args(parser):
    parser.add_argument(
        "--verbose", required=False, action="store_true", help="Set this to print a lot of stuff. Useful for debugging."
    )
    parser.add_argument(
        "--no_pbar",
        required=False,
...
def extract_fingerprint_entry():
    ...
    parser.add_argument(
        ...
        required=False,
        help=f"[OPTIONAL] Number of processes used for fingerprint extraction. Default: {default_num_processes}",
    )
    parser.add_argument(
