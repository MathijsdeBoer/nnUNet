...
if __name__ == "__main__":
    ...
    for d in args.d:
        ...
        plans["configurations"]["3d_lowres"]["architecture"]["arch_kwargs"]["strides"] = [
            [1, 1, 1],
            [2, 2, 2],
            [2, 2, 2],
        ]
        plans["configurations"]["3d_lowres"]["architecture"]["arch_kwargs"]["kernel_sizes"] = [
            [3, 3, 3],
            [3, 3, 3],
            [3, 3, 3],
        ]
        plans["configurations"]["3d_lowres"]["architecture"]["arch_kwargs"]["n_stages"] = 3
        plans["configurations"]["3d_lowres"]["architecture"]["arch_kwargs"]["features_per_stage"] = [32, 64, 128]
